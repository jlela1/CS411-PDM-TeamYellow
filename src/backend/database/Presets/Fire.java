...
public class Fire {
    ...
    public Fire() {
        ...
        garage1.variableNumVehPerMin.add(2, new numVehEnteringRate(720, 4)); //change number of vehicles entering per minute at 720 min (12pm) to 8
        ...
        //add closing times (Mary this is for you)
        garage1.closeGarageList.add(0, new closeGarage(480, true)); //set garage to closed at 480 mins
        garage1.closeGarageList.add(1, new closeGarage(720, false)); //set garage to open at 720 minutes
