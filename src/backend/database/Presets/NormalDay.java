...
public class NormalDay {
    ...
    public NormalDay() {
        ...
        garage1.variableNumVehPerMin.add(2, new numVehEnteringRate(720, 4)); //change number of vehicles entering per minute at 600 min (12pm) to 8
        garage1.variableNumVehPerMin.add(3, new numVehEnteringRate(840, 2)); //change number of vehicles entering per minute at 840 min (2pm) to 5
        garage1.variableNumVehPerMin.add(4, new numVehEnteringRate(960, 1)); //change number of vehicles entering per minute at 960 min (4pm) to 3
        ...
        garage2.variableNumVehPerMin.add(2, new numVehEnteringRate(720, 4)); //change number of vehicles entering per minute at 600 min (12pm) to 8
        garage2.variableNumVehPerMin.add(3, new numVehEnteringRate(840, 2)); //change number of vehicles entering per minute at 840 min (2pm) to 5
        garage2.variableNumVehPerMin.add(4, new numVehEnteringRate(960, 1)); //change number of vehicles entering per minute at 960 min (4pm) to 3
        ...
        garage3.variableNumVehPerMin.add(2, new numVehEnteringRate(720, 4)); //change number of vehicles entering per minute at 600 min (12pm) to 8
        garage3.variableNumVehPerMin.add(3, new numVehEnteringRate(840, 2)); //change number of vehicles entering per minute at 840 min (2pm) to 5
        garage3.variableNumVehPerMin.add(4, new numVehEnteringRate(960, 1)); //change number of vehicles entering per minute at 960 min (4pm) to 3
        ...
        garage4.variableNumVehPerMin.add(2, new numVehEnteringRate(720, 4)); //change number of vehicles entering per minute at 600 min (12pm) to 8
        garage4.variableNumVehPerMin.add(3, new numVehEnteringRate(840, 2)); //change number of vehicles entering per minute at 840 min (2pm) to 5
        garage4.variableNumVehPerMin.add(4, new numVehEnteringRate(960, 1)); //change number of vehicles entering per minute at 960 min (4pm) to 3
        ...
        GarageManager simulationStart = new GarageManager(garages, 1);
